# -*- coding: utf-8 -*-
"""iTransformer_VN_Doc_Embedding_ACB.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UFwbYeY3QaQiigfg-k1LMe2GmtQr_j4X

# iTransformer + dangvantuan/vietnamese-document-embedding Stock Prediction
...
"""# Pre-encode Text with dangvantuan/vietnamese-document-embedding"""
...
"""# Multimodal Model: iTransformer + dangvantuan/vietnamese-document-embedding
...
class iTransformerCrossAttentionMultiDayNews(nn.Module):
    """
    iTransformer + Cross-Attention model với Multi-Day News Integration.
...
if best_L in results_by_L:
    ...
    axes[1].set_title(f'iTransformer + dangvantuan/vietnamese-document-embedding Training - L={best_L}')
    axes[1].legend()
    axes[1].grid(True)
