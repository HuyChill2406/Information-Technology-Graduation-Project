# -*- coding: utf-8 -*-
"""iTransformer_ACB.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1rJTJqH2i0k00vpVTjAjaFF3fhZZuQ0yq
...
numeric_vars = ['open', 'high', 'low', 'close','MA_10', 'MA_50', 'MA_200','GDP × 10^9 (USD)', 'CPI', 'usd_vnd']
...
features_robust = ['open', 'high', 'low','MA_10', 'MA_50', 'MA_200','GDP × 10^9 (USD)', 'CPI', 'usd_vnd']
...
}, f'itransformer_L{best_L}.pth')

print(f"\nModel saved as 'itransformer_L{best_L}.pth'")