# -*- coding: utf-8 -*-
"""PatchTST_VN_Doc_Embedding_ACB.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mCbUPAF51BYckbMXZfypfXvcJap3zbxo

# PatchTST + dangvantuan/vietnamese-document-embedding Multimodal Stock Prediction
...
"""# Multimodal Model: PatchTST + dangvantuan/vietnamese-document-embedding
...
if best_L in results_by_L:
    ...
    axes[1].set_title(f'PatchTST + dangvantuan/vietnamese-document-embedding Training - L={best_L}')
    axes[1].legend()
    axes[1].grid(True)
